...
export const Route = createFileRoute("/_authenticated/request")({
  head: () => ({
    meta: [
      { title: "Request an Item — Tuckin" },
      {
        name: "description",
        content: "Tell the campus store which product to stock next and get notified when it lands.",
      },
      { property: "og:title", content: "Request an Item — Tuckin" },
      {
        property: "og:description",
        content: "Suggest products for Tuckin to carry and track your request status.",
      },
    ],
  }),
